...
export const componenti: Componente[] = [
  ...
  { compId: "C-OI-005", techId: "T002", tecnologia: "Olio", macrocomponente: "Efficienza", nome: "Cogen e heat integration", descrizione: "Recuperi termici, cogenerazione e digital energy management.", funzione: "Riduzione consumi ed emissioni", stato: "Commerciale diffusa", ultimoAggiornamento: "2026-03-28" },
  { compId: "C-OI-006", techId: "T002", tecnologia: "Olio", macrocomponente: "Abatement", nome: "Flare and methane monitoring", descrizione: "Tecnologie LDAR, riduzione flaring e monitoraggio perdite.", funzione: "Riduzione emissioni fuggitive", stato: "Commerciale iniziale", ultimoAggiornamento: "2026-03-28" },
  // Gas Naturale
  { compId: "C-GA-002", techId: "T003", tecnologia: "Gas Naturale", macrocomponente: "Generazione", nome: "Turbina a gas simple cycle", descrizione: "Macchine flessibili per picco e servizi ancillari.", funzione: "Peak load e fast ramping", stato: "Commerciale diffusa", ultimoAggiornamento: "2026-03-28" },
  { compId: "C-GA-003", techId: "T003", tecnologia: "Gas Naturale", macrocomponente: "Generazione", nome: "CCGT H/F class", descrizione: "Cicli combinati ad alta efficienza per mid-merit e baseload flessibile.", funzione: "Generazione efficiente e modulabile", stato: "Commerciale diffusa", ultimoAggiornamento: "2026-03-28" },
  { compId: "C-GA-005", techId: "T003", tecnologia: "Gas Naturale", macrocomponente: "Decarbonizzazione", nome: "CCS-ready / post-combustion CCS", descrizione: "CCGT con cattura CO2 integrata.", funzione: "Decarbonizzazione dispatchable", stato: "FOAK / pre-commerciale", ultimoAggiornamento: "2026-03-28", note: "Prerequisito per decarbonizzazione del gas naturale" },
  { compId: "C-GA-006", techId: "T003", tecnologia: "Gas Naturale", macrocomponente: "Transizione", nome: "Hydrogen-ready combustion", descrizione: "Turbine predisposte a blend H2 crescente.", funzione: "Transizione verso low-carbon gas", stato: "Commerciale iniziale", ultimoAggiornamento: "2026-03-28", note: "Turbine predisposte a blend H2 crescente fino al 100%" },
  // Solare Termico
  { compId: "C-ST-001", techId: "T005", tecnologia: "Solare Termico", macrocomponente: "Captazione solare", nome: "Campo collettori / eliostati", descrizione: "Superficie ottica che concentra o raccoglie la radiazione solare.", funzione: "Raccolta energia solare", stato: "Commerciale diffusa", ultimoAggiornamento: "2026-03-28" },
  { compId: "C-ST-002", techId: "T005", tecnologia: "Solare Termico", macrocomponente: "Accumulo termico", nome: "Serbatoio / TES termico", descrizione: "Accumulo molten salt per spostare produzione nel tempo.", funzione: "Dispatchability e spostamento energetico", stato: "Commerciale diffusa", ultimoAggiornamento: "2026-03-28" },
  { compId: "C-ST-003", techId: "T005", tecnologia: "Solare Termico", macrocomponente: "Conversione", nome: "Ricevitore e fluido termovettore", descrizione: "Receiver e HTF determinano temperatura e rendimento.", funzione: "Trasferimento calore", stato: "Commerciale diffusa", ultimoAggiornamento: "2026-03-28" },
  { compId: "C-ST-004", techId: "T005", tecnologia: "Solare Termico", macrocomponente: "Power block", nome: "Steam cycle / ORC / chiller", descrizione: "Ottimizzazione del power block e integrazione con process heat.", funzione: "Conversione termoelettrica", stato: "Commerciale diffusa", ultimoAggiornamento: "2026-03-28" },
  // Idroelettrico
  { compId: "C-HY-002", techId: "T007", tecnologia: "Idroelettrico", macrocomponente: "Elettromeccanica", nome: "Turbina e generatore", descrizione: "Core technology matura con miglioramenti su efficienza e digital O&M.", funzione: "Conversione idraulico-elettrica", stato: "Commerciale diffusa", ultimoAggiornamento: "2026-03-28" },
  { compId: "C-HY-004", techId: "T007", tecnologia: "Idroelettrico", macrocomponente: "Storage", nome: "Pumped storage", descrizione: "PSH resta la principale tecnologia di storage a lunga durata su larga scala.", funzione: "Accumulo e bilanciamento di rete", stato: "Commerciale diffusa", ultimoAggiornamento: "2026-03-28" },
  { compId: "C-HY-005", techId: "T007", tecnologia: "Idroelettrico", macrocomponente: "Revamping", nome: "Repowering e upgrading", descrizione: "Incremento output su parco esistente.", funzione: "Ottimizzazione e ammodernamento", stato: "Commerciale diffusa", ultimoAggiornamento: "2026-03-28" },
  // Biomasse
