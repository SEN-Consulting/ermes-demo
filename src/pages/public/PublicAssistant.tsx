...
const suggestedPrompts = [
  ...
  "Quali novità sull'idrogeno verde negli ultimi 6 mesi?",
...
function getSimulatedResponse(userMessage: string): string {
  ...
  if (lower.includes("idrogeno") || lower.includes("hydrogen")) return simulatedResponses["quali novità sull'idrogeno verde negli ultimi 6 mesi?"];
  if (lower.includes("sviluppo") || lower.includes("developing") || lower.includes("africa")) return simulatedResponses["quali tecnologie sono più adatte ai paesi in via di sviluppo?"];
  ...
  return "Grazie per la domanda. In base all'analisi del portafoglio ERMES, posso confermare che il tema è attualmente monitorato dal nostro osservatorio.\n\nPer una risposta dettagliata, ti consiglio di:\n1. Consultare la sezione **Tecnologie** per le schede complete\n2. Accedere alla **Webapp** per l'analisi a 360° con dati su componenti, costi, TRL e policy\n3. Consultare le **Pubblicazioni** per report e policy brief aggiornati\n\nL'assistente ERMES è alimentato da un modello AI addestrato sui contenuti dell'osservatorio e aggiornato periodicamente con le evidenze raccolte.";
}
      ...
      <div className="flex flex-col" style={{ height: "calc(100vh - 220px)" }}>
        ...
        <div className="border-t border-slate-200 px-4 py-4">
          ...
          <div className="mt-2 text-center text-xs text-slate-400">
            ERMES può commettere errori. Le risposte sono generate dall'osservatorio tecnologico FEEM.
          </div>
        </div>
      </div>
    </div>
